...
export default function SuggestedProperty() {
  ...
  const getAllProperties = async () => {
    try {
      const response = await axios.get(`https://real-estate.doaguru.com/api/property/getAllPropertyAdmin/`);
  ...
  const getSuggestedProperties = async () => {
    try {
      const response = await axios.get('https://real-estate.doaguru.com/api/property/getSuggestedPropertyAdmin');
  ...
  const deleteProperty = async (propertyId) =>{
    ...
    if (!isConfirmed) {
      ...
      const response = await axios.delete(`https://real-estate.doaguru.com/api/property/deleteproperty/${propertyId}`,{
             headers:{
  ...
  const markPropertySold = async (propertyId) =>{
    ...
    if (!isConfirmed) {
      ...
      const response = await axios.put(`https://real-estate.doaguru.com/api/property/markedAsSold/${propertyId}`,
      {},
      {
             headers:{
              'Authorization': `Bearer ${token}`,
  ...
  const addToSuggested = async (propertyId) => {
    ...
    if (!isConfirmed) {
      ...
      const response = await axios.post('https://real-estate.doaguru.com/api/property/addSuggestedProperty',{ property_id: propertyId }, {
        headers: {
            'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
        },
  ...
  const removeSuggested = async (propertyId) =>{
    ...
    if (!isConfirmed) {
      ...
      const response = await axios.delete(`https://real-estate.doaguru.com/api/property/removeSuggestedProperty/${propertyId}`,{
             headers:{
              'Authorization': `Bearer ${token}`,
              'Content-Type': 'application/json',
             }
