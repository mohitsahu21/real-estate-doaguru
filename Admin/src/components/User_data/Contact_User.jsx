  ...
  const token = currentAdmin?.token;
    ...
    useEffect(()=>{
      const fetchUser = async() =>{
          ...
          try{
            const res = await axios.get('https://real-estate.doaguru.com/api/property/getContactedUsers');
    ...
    if (!isConfirmed) {
      ...
      try{
        const res = await axios.delete(`https://real-estate.doaguru.com/api/property/deleteContactedUser/${id}`,
        {
          headers:{
