...
const EditImages = () => {
    ...
    const fetchPropertyImages = async (propertyId) => {
      try {
        const response = await axios.get(`https://real-estate.doaguru.com/api/property/getPropertyImagesById/${propertyId}`);
    ...
    if (!isConfirmed) {
      ...
      return;
            ...
            const response = await axios.delete(`https://real-estate.doaguru.com/api/property/delete-property-image/${imageId}`,{
                headers:{
